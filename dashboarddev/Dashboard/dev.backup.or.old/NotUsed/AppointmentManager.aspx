...
<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeFile="AppointmentManager.aspx.cs" MasterPageFile="~/Masterpages/dbm_leads_win.master" Inherits="AppointmentManager" %>
    ...
    <div class="WindowDivContainer" style="width:810px;">
        <div ID="div_authenticate" runat="server" visible="false">
            ...
            <div style="width:170px; margin:0 auto;">
                ...
                OnClientClicking="function(button, args){ $('#Body_div_authenticate').hide(); $('#Body_lbl_authed').hide(); window.open('authwithgmapi.aspx','_newtab'); GetRadWindow().autoSize(); return false; }"/>
            </div>
        </div>
...
<%--        <div ID="div_blocked_popups" runat="server" style="display:none; position:fixed; bottom:0px; right:0px;">
        ...
        <asp:Label ID="lbl_authed" runat="server" CssClass="TinyTitle" Text="You are authenticated with Google Mail API.." ForeColor="Green" style="position:fixed; bottom:0px; right:0px;"/>
    </div>
