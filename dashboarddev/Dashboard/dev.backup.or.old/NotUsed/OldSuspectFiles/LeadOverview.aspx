...
<asp:Content ContentPlaceHolderID="Body" runat="server">
    ...
    <div ID="div_tmpl" runat="server" class="WindowDivContainer" style="width:1140px; background-color:#fdfdfd; margin:0px; margin-top:6px;">
                        ...
                        <asp:UpdatePanel ID="udp_com_m" runat="server" ChildrenAsTriggers="true">
                            <ContentTemplate>
                                ...
                                ShowCompanyHeader="False" ShowDateAddedUpdated="False" ShowCompanyLogo="False" ShowDashboardAppearances="False" ShowCompanyNameHeader="False" 
                                    ShowCompanyViewer="True" ShowCompanyEditor="False" ShowCompanyEditorWrapper="True"/>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div> 
                </td>
                        ...
                        <asp:UpdatePanel ID="udp_contacts" runat="server" ChildrenAsTriggers="true">
                            <ContentTemplate>
                                <telerik:RadGrid ID="rg_contacts" runat="server" ItemStyle-HorizontalAlign="Center" AlternatingItemStyle-HorizontalAlign="Center" ShowHeader="false"
                                    ...
                                    <MasterTableView BorderWidth="0" AutoGenerateColumns="false" TableLayout="Auto" NoMasterRecordsText="There are no other contacts for this company.">
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="ctc_id" UniqueName="ContactID" Display="false" HtmlEncode="true"/>
                                            ...
                                            <telerik:GridBoundColumn DataField="job_title" UniqueName="JobTitle" HeaderText="Job Title" HtmlEncode="true"/>
                                            <telerik:GridBoundColumn DataField="email" UniqueName="Email" Display="false" HtmlEncode="true"/>
                                            <telerik:GridBoundColumn DataField="personal_email" UniqueName="PEmail" Display="false" HtmlEncode="true"/>
                ...
                <td valign="top">
                    <div style="margin:4px 4px 0px 4px">
                        ...
                        <asp:UpdatePanel ID="udp_notes" runat="server" ChildrenAsTriggers="true">
                            <ContentTemplate>
                                <uc:ContactNotesManager ID="ContactNotesManager" runat="server" IncludeCommonNotes="true" ShowNotesAndNextActionTitle="false" NotesListHeight="150" InWindow="true"/>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                </td>
            ...
            <tr>
                <td colspan="2">
                    <div class="ExpandTemplateToolBar">
                        <asp:Button ID="btn_push_to" runat="server" CssClass="LButton"/>
                        ...
                        <div class="ProjectsSelectorContainer" style="display:inline-block; margin-left:4px;">
                            <asp:UpdatePanel ID="udp_move" runat="server" ChildrenAsTriggers="true">
                                <ContentTemplate>
                                    ...
                                    <asp:Button ID="btn_move_lead" runat="server" Text="Move Lead to Selected Project" CausesValidation="false" CssClass="LButton" OnClick="MoveLead" style="position:relative; top:3px; margin-left:4px;"
                                            OnClientClick="AlertifyConfirm('Are you sure?', 'Sure?', 'Body_btn_move_lead', false);"/>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </div>
