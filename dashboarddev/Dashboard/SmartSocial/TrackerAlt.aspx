...
<%@ Page Title="SMARTsocial Tracker" Language="C#" MasterPageFile="~/Masterpages/dbm.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="TrackerAlt.aspx.cs" Inherits="SmartSocialTracker" %>  
        ...
        <div ID="div_main_update" runat="server">
            ...
            <telerik:RadGrid ID="rg_features" runat="server" OnItemDataBound="rg_features_ItemDataBound" Skin="Bootstrap" PagerStyle-Position="TopAndBottom"
                ...
                <MasterTableView AutoGenerateColumns="false" TableLayout="Auto" NoMasterRecordsText="&nbsp;There are no features in this issue yet.." Font-Size="10" HierarchyLoadMode="Client">  
                    <Columns>
                        <telerik:GridBoundColumn DataField="cpy_id" UniqueName="cpy_id" Display="false" HtmlEncode="true"/>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Editor" UniqueName="Editor" SortExpression="territory_magazine">
                            <ItemTemplate>
                                <asp:Label ID="lbl_editor" runat="server" Text='<%#:Bind("writer") %>' style="cursor:pointer;"/>
                                <telerik:RadToolTip ID="rtt_editor" runat="server" Text='<%#:Bind("writer") %>' Skin="Silk" ManualClose="true" Sticky="true" TargetControlID="lbl_editor"/>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    ...
                    <NestedViewTemplate>
                        <div style="background:#f5f5f5;">
                            ...
                            <asp:HiddenField ID="hf_cpy_id" runat="server" Value='<%#: Bind("cpy_id") %>'/>
                        </div>
                    </NestedViewTemplate>
                </MasterTableView>
