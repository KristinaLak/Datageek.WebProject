...
<%@ Page Title="DataGeek :: Training ToolBox" ValidateRequest="false" Language="C#" MasterPageFile="~/Masterpages/dbm.master" AutoEventWireup="true" CodeFile="WDMToolBox.aspx.cs" Inherits="WDMToolBox" %>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function UploadComplete(sender, args) {
                ...
                var tabStrip = $find("<%=rts_box.ClientID %>");
                grab("<%= hf_tab_idx.ClientID %>").value = tabStrip.get_selectedTab().get_index();
                location.reload();
            }
...
<asp:Content ContentPlaceHolderID="Body" runat="server">
    ...
    <div id="div_page" runat="server" class="normal_page">
        <hr />
            ...
            <table width="99%" style="font-family:Verdana; position:relative; left:2px; top:-2px;">
                <tr>
                    <td align="left" valign="top">
                        ...
                        <asp:Label runat="server" Text="ToolBox" ForeColor="White" Font-Bold="false" Font-Size="Medium"/> 
                        <br />
                    </td>
            ...
            <%--MAIN TABLE--%>
            <telerik:RadTabStrip ID="rts_box" runat="server" AutoPostBack="true" BorderColor="#99CCFF" BorderStyle="None" Skin="Vista" style="position:relative; left:5px; top:2px;"/>
            <table border="0" width="99%" style="margin-left:auto; margin-right:auto; border-top:solid 1px darkgray;" bgcolor="gray">                            
                <tr>
                    ...
                    <td valign="top" align="right" width="35%" style="border-left:solid 1px OldLace;">
                        <table runat="server" id="tbl_upload" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="left"><asp:Label runat="server" Text="Upload .doc, .docx, .xls, .xlsx or .pdf file (10MB max):" ForeColor="Orange"/></td>
                            </tr>
                            <tr>
                                <td align="center">
                            ...
                            <tr>
                                <td align="left">
                                    <br />Click "Select File" and browse for your document.<br /> Re-uploading a file with the same name as an existing file will update (overwrite) the existing file. 
                                </td>
                            </tr>
                            <tr>
                                <td align="center">
                ...
                <tr>
                    <td align="center" valign="top" colspan="2"> 
                        <%--Info Label--%>
                        <asp:Label runat="server" ID="lbl_opendoc" ForeColor="Orange" Text="<br/>Select a document to view it here or download a copy using the save icon.<br/><br/>" />
                    </td>
                </tr>            
                <tr>
                        ...
                        <div runat="server" id="div_googledocs" visible="false">
                            <table border="0" cellpadding="0" cellspacing="0" style="position:relative; left:2px;">
                                ...
                                <tr>
                                    ...
                                    <td><asp:Button runat="server" ID="btn_closegoogle" Text="Close Document" OnClick="CloseGoogleDoc" Width="130" style="position:relative; left:-2px;"/></td>
            ...
            <asp:HiddenField ID="hf_tab_idx" runat="server"/>
        <hr />
    </div>
</asp:Content>