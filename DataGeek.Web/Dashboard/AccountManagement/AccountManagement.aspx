...
<asp:Content ContentPlaceHolderID="Body" runat="server">
    <telerik:RadWindowManager Skin="Black" VisibleStatusbar="false" runat="server" ShowContentDuringLoad="false">
        <Windows>
                        ...
                        <table border="1" cellpadding="1" cellspacing="0" width="300px" bgcolor="White" style="margin-left:11px; font-family:Verdana; font-size:8pt">
                            ...
                            <tr>
                                <td style="border-right:0;">
                                    <asp:Label runat="server" Font-Bold="true" Text="Add | Disable | Edit" style="margin-left:3px;"/>
                                    <asp:Label runat="server" Font-Bold="true" ID="editRolesTextLabel" Text=" | Roles"/>
                                </td>
                                <td align="right" style="border-left:0;">
                                    <asp:Label runat="server" Text="Only Terminated"/>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <asp:ImageButton ID="deleteUserButton" OnClick="deleteExistingUserClick" ToolTip="Disable Existing User Account" height="30px" width="30px" runat="server" ImageUrl="~/Images/Icons/admin_DeleteUser.png" style="position:relative; left:11px;"/>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Panel runat="server" ID="selectUserPanel" Visible="false">
                                        ...
                                        <asp:ImageButton ID="closeLoadselectUserPanelButton" runat="server" Height="17" Width="17" ImageUrl="~\Images\Icons\dashboard_Close.png" OnClick="closeLoadUserPanels" style="float:right; margin:3px;"/>
                                    </asp:Panel>
                                    <asp:Panel runat="server" ID="deleteUserPanel" Visible="false">
                                        <img src="/Images/Misc/titleBarAlpha.png" alt="Pick User" style="position:relative; top:-1px; left:-1px;"/>
                                        <img src="/Images/Icons/admin_User.png" alt="Users" height="20px" width="20px" style="position:relative"/>
                                        <asp:Label Text="Disable User" runat="server" ForeColor="White" style="position:relative; top:-7px; left:-194px;"/>
                                        <asp:ImageButton ID="closeLoaddeleteUserPanelButton" runat="server" Height="17" Width="17" ImageUrl="~\Images\Icons\dashboard_Close.png" OnClick="closeLoadUserPanels" style="float:right; margin:3px;"/>
                                    </asp:Panel>
...
<%--                                        <asp:Button ID="deleteSelectedUserButton" OnClick="deleteUser" Text="Delete" runat="server" Enabled="false" Width="60px" 
                    ...
                    <td valign="top" align="left">
                        <%-- EXISTING USER--%>
                        <asp:Panel ID="pnl_userpreferences" runat="server" Visible="false" style="margin-left:6px; font-family:Verdana; font-size:8pt">
                            <table border="1" cellpadding="1" cellspacing="0" bgcolor="White" style="width:668px; margin-left:2px; font-family:Verdana; font-size:8pt">
                                <tr>
                                    <td align="left" style="border-right:0px;">
                                        <img src="/Images/Misc/titleBarAlpha.png" style="position:relative; top:-1px; left:-1px;"/>
                                        <asp:Label Text="Edit User" runat="server" ForeColor="White" style="position:relative; top:-7px; left:-170px;"/>
                                    </td>
                                    <td align="right" style="border-left:0px;">
                                        <asp:ImageButton runat="server" alt="Close" Height="17" Width="17" ImageUrl="~\Images\Icons\dashboard_Close.png" OnClick="closeUserPanel" style="float:right; margin:3px;"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" colspan="2">
                                        <table border="0" cellpadding="1" cellspacing="5" width="100%">
                                            <tr>
                                                <td align="left" width="25%"><asp:Label runat="server" Text="Full Name:"/></td>
                                                <td width="30%"><asp:TextBox ID="Fullname" width="200" runat="server"/></td>
                                                <td align="left" valign="top" rowspan="4" style="border-left:1px dotted gray;" width="20%"><asp:Label runat="server" Text="&nbsp;CCA Group:"/></td>
                                                <td rowspan="4" width="25%">
                                                    <asp:RadioButtonList ID="CCAGroupRadioButton" runat="server">
                                            ...
                                            <tr>
                                                <td align="left"><asp:Label runat="server" Text="Friendly Name:"/></td>
                                                <td><asp:TextBox ID="Friendlyname" runat="server" width="200"/></td>
                                            </tr>
                                            <tr>
                                                <td align="left"><asp:Label runat="server" Text="E-mail:"/></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td align="left"><asp:Label runat="server" Text="Regional Mag:"/></td>
                                                <td><asp:DropDownList ID="dd_region" runat="server" Width="170"/></td>
                                            </tr>
                                            <tr>
                                                <td align="left"><asp:Label runat="server" Text="Sector:"/></td>
                                                <td><asp:DropDownList ID="dd_sector" runat="server" Width="170"/></td>
                                                <td align="left" valign="top" rowspan="3" style="border-left:1px dotted gray;">
                                                    <asp:Label ID="CCATeamRadioButtonLabel" runat="server" Text="&nbsp;CCA Team:"/>
                                                </td>
                                                <td valign="top" rowspan="3"><asp:RadioButtonList ID="CCATeamRadioButton" runat="server"/></td>
                                            </tr>
                                            <tr>
                                                <td align="left">Sub-Sector:</td>
                                                <td><asp:TextBox ID="tb_sub_sector" runat="server" Width="165"/></td>
                                            </tr>
                                            <tr>
                                                <td align="left">Office:</td>
                                                <td><asp:DropDownList runat="server" ID="OfficeDropDownList" AutoPostBack="true" OnTextChanged="getTeamsForSelectedOffice" width="170px"/></td>
                                            </tr>
                                            <tr>
                                                <td align="left">Phone Number:</td>
                                                <td><asp:TextBox ID="UserPhoneNumberBox" runat="server" Width="165"/></td>
                                                <td align="left" valign="top" style="border-left:1px dotted gray;"><asp:Label runat="server" Text="&nbsp;Add to Reports:"/></td>
                                                <td valign="top"><asp:CheckBox ID="cb_add_to_reports" runat="server" Text="(e.g. PR)"/></td>
                                            </tr>
                                            <tr>
                                                <td align="left">Account Type:</td>
                                                <td>
                                                    <table><tr>
                                                        <td><asp:DropDownList Enabled="false" runat="server" Width="120" ID="dd_EditUserPermissions" style="position:relative; left:-3px;">
                                                    ...
                                                    <td><asp:Button alt="Customise Privelidges" ID="imbtn_editprivs" runat="server" Text="Customise" style="position:relative; left:2px;" OnClick="goToRoles"/></td>
                                                    <td><asp:ImageButton alt="Info" runat="server" Height="20" Width="20" ImageUrl="~\Images\Icons\dashboard_Info.png" style="position:relative; left:2px;" OnClientClick="openHelp(); return false;"/></td>
                                                    </tr></table>
                                                </td>
                                                <td align="left" valign="top" rowspan="5" style="border-left:1px dotted gray;"><asp:Label ID="teamLeaderLabel" runat="server" Text="&nbsp;Team Leader:"/></td>
                                            ...
                                            <tr>
                                                <td align="left"><asp:Label runat="server" Text="Current Employee:"/></td>
                                                <td><asp:CheckBox ID="employed" runat="server" Text="Unchecking this box disables the account." onclick="if(this.checked){alert('If you are re-enabling an account, make sure you also click the Unlock Account button below - this allows the user to log in.');};"/></td>
                                            </tr>
                                            <tr>
                                                <td align="left"><asp:Label runat="server" Text="Starter:"/></td>
                                                <td><asp:CheckBox ID="starter" runat="server"/></td>
                                            </tr>
                                            <tr>
                                                <td align="left"><asp:Label runat="server" Text="T&D Commission:"/></td>
                                                <td><asp:CheckBox ID="cb_edit_t_and_d_commission" runat="server" AutoPostBack="true" OnCheckedChanged="ToggleEditTandDCommission"/></td>
                                            </tr>
                                            <tr>
                                                <td align="left"><asp:Label runat="server" Text="On-Site Access Only:"/></td>
                                                <td><asp:CheckBox ID="cb_onsite_only" runat="server" Text="Limited access to DataGeek outside of our offices"/><asp:LinkButton ID="lb_whitelist_pages_list" runat="server" Text="(Click here to show allowed pages)" ForeColor="#4C6196" style="margin-left:5px;"/></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <table ID="tbl_edit_t_and_d_commission" runat="server" visible="false" width="75%" style="margin-left:15px;">
                                                        <tr><td colspan="2">A trainer will receive X commission on all of this user's deals for the first 90 days of their employ or until a specified expiry date.</td></tr>
                                                        <tr>
                                                            <td>Percentage:</td>
                                                            <td>Trainer:</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox ID="tb_edit_t_and_d_percentage" runat="server" Text="2.5" Width="80"/>
                                                                <asp:CompareValidator runat="server" ControlToValidate="tb_edit_t_and_d_percentage" Operator="GreaterThan" ForeColor="Red" Type="Double" Display="Dynamic" ValueToCompare="0" Text="<br/>Must be a valid number"/> 
                                                                <asp:RequiredFieldValidator runat="server" ForeColor="Red" ControlToValidate="tb_edit_t_and_d_percentage" Display="Dynamic" Text="Required!" Enabled="false"/>
                                                            </td>
                                                            <td><asp:DropDownList ID="dd_edit_t_and_d_recipient" runat="server"/></td>
                                                        </tr>
                                                        <tr><td colspan="2">Eligibility Expiry (inclusive, optional):</td></tr>
                                                        <tr><td colspan="2"><telerik:RadDatePicker ID="rdp_edit_t_and_d_expiry" runat="server"/></td></tr>
                                                        <tr><td colspan="2"><asp:CheckBox ID="cb_edit_t_and_d_update" runat="server" Text="Apply T&D changes to any existing deals?" Checked="false" /></td></tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top"><asp:Label runat="server" Text="User Colour:" style="position:relative; top:2px;"/></td>
                                                <td>
                                                    <asp:TextBox ID="editUserColourBox" runat="server"/>
                                                    <br />
                                                    <div style="position:relative; top:10px; left:-100px;">
                                                    <telerik:RadColorPicker ID="editUserColourPicker" runat="server"
                                                        AutoPostBack="false" RenderMode="Lightweight"
                                                        OnClientColorChange="editColorChange"
                                                        Preset="Default"
                        ...
                        <%--NEW USER--%>
                        <asp:Panel ID="addNewUserPanel" runat="server" style="margin-left:6px; font-family:Verdana; font-size:8pt; display:none;">
                            <table border="1" cellpadding="1" cellspacing="0" bgcolor="White" style="width:668px; margin-left:2px; font-family:Verdana; font-size:8pt">
                                <tr>
                                    <td align="left" style="border-right:0px;">
                                    ...
                                    <td align="right" style="border-left:0px;">
                                        <asp:ImageButton id="closeNewUserPanelButton" alt="Close" runat="server" Height="17" Width="17" ImageUrl="~\Images\Icons\dashboard_Close.png" onclick="closeNewUserPanel" style="float:right; margin:3px;"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" colspan="2">
                                        <table border="0" cellpadding="1" cellspacing="5">
                                            <tr>
                                                ...
                                                <td align="left" valign="top" width="100" rowspan="3" style="border-left:1px dotted gray;">&nbsp;CCA Group:</td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" valign="top" rowspan="8" style="border-left:1px dotted gray;">
                                            ...
                                            <tr>
                                                <td align="left"><asp:Label runat="server" Text="T&D Commission:"/></td>
                                                <td><asp:CheckBox ID="cb_t_and_d_commission" runat="server" Enabled="false" AutoPostBack="true" OnCheckedChanged="ToggleTandDCommission"/></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <table ID="tbl_t_and_d_commission" runat="server" visible="false" width="75%" style="margin-left:5px;">
                                                        <tr><td colspan="2">A trainer will receive X commission on all of this new user's deals for the first 90 days of their employ or until a specified expiry date.</td></tr>
                                                        <tr>
                                                            <td>Percentage:</td>
                                                            <td>Trainer:</td>
                                                        </tr>
                                                        ...
                                                        <tr><td colspan="2">Eligibility Expiry (inclusive, optional):</td></tr>
                                                        <tr><td colspan="2"><telerik:RadDatePicker ID="rdp_t_and_d_expiry" runat="server"/></td></tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            <tr>
                                               ...
                                               <td colspan="2">
                                                    <table cellpadding="0" cellspacing="0" style="position:relative; left:-184px;">
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButtonList ID="rbl_officeadmindesign" runat="server" CellPadding="0" CellSpacing="0"  Width="260" RepeatDirection="Horizontal">
                                            ...
                                            <tr>
                                                <td valign="top" colspan="2">
                                                    ...
                                                    <telerik:RadColorPicker
                                                        ID="userColourPicker" RenderMode="Lightweight"
                                                        runat="server"
                                                        AutoPostBack="false"
                                                        OnClientColorChange="colorChange" 
                                                        Preset="Default"
                                                        KeepInScreenBounds="true" Height="250px" Width="250px"
                                                        PreviewColor="True"
                                                        ShowEmptyColor="False"
                                                        Skin="Vista" SelectedColor="White">
                                                    </telerik:RadColorPicker>
                ...
                <tr>
                    <td valign="top">
                        ...
                        <table border="1" cellpadding="1" cellspacing="0" width="300px" bgcolor="White" style="margin-left:11px; font-family:Verdana; font-size:8pt">
                            ...
                            <tr><td><asp:Label runat="server" Font-Bold="true" Text="Add | Edit" style="margin-left:3px;"/></td></tr>
                            <tr>
                                <td>
                    ...
                    <td valign="top" align="left">
                        <asp:Panel runat="server" ID="AddEditCCAPanel" visible="false" style="margin-left:6px; font-family:Verdana; font-size:8pt">
                            <table border="1" cellpadding="1" cellspacing="0" width="300px" bgcolor="White" style="margin-left:2px; font-family:Verdana; font-size:8pt">
                                <tr>
                                    <td align="left">
                                        ...
                                        <asp:ImageButton id="CloseEditCCATeamLabelButton" alt="Close" runat="server" Height="17" Width="17" ImageUrl="~\Images\Icons\dashboard_Close.png" onclick="closeTeamPanel" style="float:right; margin:3px;"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                                        <table border="0" width="330px" cellpadding="1" cellspacing="5">
                                            <tr>                                       
                                                <td valign="bottom">Team Territory</td>
                                                <td valign="bottom" colspan="2">Team Name</td>
                                            </tr>
                                            <tr>
                                                <td>
        ...
        <asp:Panel ID="otherPanel" runat="server">
                            ...
                            <tr>
                                <td valign="top">  
                                    <table border="1" cellpadding="1" cellspacing="0" bgcolor="White" height="235" width="300px">
                                        ...
                                        <tr>
                                            <td>
                                                <div style="height:232px; overflow:auto;">
                                ...
                                <table ID="retrievePasswordTable" runat="server" border="1" cellpadding="1" cellspacing="0" bgcolor="White" style="position:relative; width:340px; top:-3px; font-family:Verdana; font-size:8pt">
                                    ...
                                    <tr>
                                        <td colspan="2" style="border-bottom:0px;">
                                            ...
                                            SubmitButtonText="Get Password" SubmitButtonType="Link" MailDefinition-From="no-reply@bizclikmedia.com" MailDefinition-Subject="DataGeek Login Details" MailDefinition-Priority="High" OnVerifyingUser="VerifyEmailAddress">
                                                <UserNameTemplate>
                                            ...
                                            <asp:Button runat="server" ID="btn_reset_all_passwords" Text="Reset All Passwords" OnClick="ResetAllPasswords" Visible="false" style="margin-left:3px;" OnClientClick="return confirm('Are you sure?')"/>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <asp:Panel runat="server" ID="adminsPanel" style="margin-left:10px; font-family:Verdana; font-size:8pt">
                <hr style="margin-right:8px;"/>
                <%--Admins Head--%>
                <table border="1" cellpadding="1" cellspacing="0" width="975px" bgcolor="White">
                    <tr>
                        <td>
                            <img src="/Images/Misc/titleBarAlpha.png" alt="" style="position:relative; top:-1px; left:-1px;"/>
                            <img src="/Images/Icons/button_Admin.png" alt="" height="20px" width="20px"/>
                            <asp:Label Text="User Roles" runat="server" ForeColor="White" style="position:relative; top:-7px; left:-192px;"/>
                            <asp:ImageButton alt="Info" runat="server" Height="20" Width="20" ImageUrl="~\Images\Icons\dashboard_Info.png" OnClientClick="openHelp(); return false;" style="position:relative; left:25px;"/>
                        </td>
                        <td>
                            &nbsp;<asp:TextBox runat="server" ID="whiteLabel" enabled="false" width="10" height="10" BackColor="White"/>
                            <asp:Label runat="server" Text=" Custom&nbsp;"/>
                        </td>
                        <td>
                            &nbsp;<asp:TextBox runat="server" ID="brownLabel" enabled="false" width="10" height="10" BackColor="Brown"/>
                            <asp:Label runat="server" Text=" CCA&nbsp;"/>
                        </td>
                        <td>
                            &nbsp;<asp:TextBox runat="server" ID="grayLabel" enabled="false" width="10" height="10" BackColor="Gray"/>
                            <asp:Label runat="server" Text=" User&nbsp;"/>
                        </td>
                        <td>
                            &nbsp;<asp:TextBox runat="server" ID="greenYellowLabel" enabled="false" width="10" height="10" BackColor="GreenYellow"/>
                            <asp:Label runat="server" Text=" Group User&nbsp;"/>
                        </td>
                        <td>
                            &nbsp;<asp:TextBox runat="server" ID="greenLabel" enabled="false" width="10" height="10" BackColor="LightGreen"/>
                            <asp:Label runat="server" Text=" Finance&nbsp;"/>
                        </td>
                        <td>
                            &nbsp;<asp:TextBox runat="server" ID="khakiLabel" enabled="false" width="10" height="10" BackColor="Khaki"/>
                            <asp:Label runat="server" Text=" Team Leader&nbsp;"/>
                        </td>
                        <td>
                            &nbsp;<asp:TextBox runat="server" ID="aquaLabel" enabled="false" width="10" height="10" BackColor="Aqua"/>
                            <asp:Label runat="server" Text=" HoS&nbsp;"/>
                        </td>
                        <td>
                            &nbsp;<asp:TextBox runat="server" ID="redLabel" enabled="false" width="10" height="10" BackColor="Red"/>
                            <asp:Label runat="server" Text=" Admin&nbsp;"/>
                        </td>
                    </tr>
                </table>
                <div runat="server" id="div_permissionsarea"/>
            </asp:Panel> <%-- End Admins Panel--%>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function editColorChange(sender, eventArgs) {
            var cb = grab("<%= editUserColourBox.ClientID%>");
            cb.value = sender.get_selectedColor();
        }
