...
<asp:Content ContentPlaceHolderID="Body" runat="server">
    ...
    <div class="WindowDivContainer" style="width:930px; margin:15px 0px 15px 15px;">
        <asp:Label runat="server" CssClass="MediumTitle" Text="In order to push this Lead to Prospect level you must specify at least <b>Industry</b>, <b>Turnover</b>, <b>Company Size</b> and <b>Website</b>.."/>
        <asp:Label runat="server" CssClass="TinyTitle" Text="You must also have <b>Country</b> specified.." style="margin-bottom:7px;"/>
        <asp:UpdatePanel ID="udp_ptp" runat="server" ChildrenAsTriggers="true">
            <ContentTemplate>
                <table style="height:600px; width:900px;">
                    <tr>
                        <td colspan="4">
                            <uc:CompanyManager ID="CompanyManager" runat="server" ShowCompanyHeader="false" AutoCompanyMergingEnabled="true"
                    ...
                    <tr>  
                        ...
                        <td>
                            <telerik:RadDropDownList ID="dd_p1p2" runat="server">
                                <Items>
                        ...
                        <td colspan="3">
                            <telerik:RadDropDownList ID="dd_emails" runat="server">
                                <Items>
                                    <telerik:DropDownListItem Text=""/>
                                    <telerik:DropDownListItem Text="Y" Value="1"/>
                                    <telerik:DropDownListItem Text="N" Value="0"/>
                                </Items>
                            </telerik:RadDropDownList>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:Label runat="server" Text="Expand contacts to specify contact types as necessary (e.g. Suspect Contact, List Provider etc.)" CssClass="TinyTitle" style="margin-top:6px; margin-bottom:0px; margin-left:10px;"/>
                            <uc:ContactManager ID="ContactManager" runat="server" IncludeContactTypes="true" TargetSystem="Prospect" SelectableContactsHeaderText="Push?" 
                                SelectableContacts="true" AllowCreatingContacts="true" AutoSelectNewContacts="false" OnlyShowTargetSystemContactTypes="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="left">
                            <asp:CheckBox ID="cb_view_writeup" runat="server" Checked="true" Text="View Prospect Write-Up after pushing to Prospect"/>
                        </td>
                        <td colspan="2" align="right">
                            <asp:Button ID="btn_push_to_prospect" runat="server" Text="Push to Prospect" CssClass="LButton" 
                            OnClientClick="if(!Page_ClientValidate()){ return Alertify('Please fill in the required fields and make sure to check that there are no errors with the data entered for the company and its contacts (you may need to expand the contacts to check).', 'Required Data'); } else{ return AlertifyConfirm('Are you sure?', 'Sure?', 'Body_btn_push_to_prospect_serv', false); }"/>
                            <asp:Button ID="btn_push_to_prospect_serv" runat="server" OnClick="PushLeadToProspect" style="display:none;"/>    
                        </td>
                    </tr>
                </table>  
            </ContentTemplate>
