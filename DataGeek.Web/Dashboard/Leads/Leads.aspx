...
<%@ Page Title="DataGeek :: Leads" Language="C#" MasterPageFile="~/Masterpages/dbm_leads.master" AutoEventWireup="true" CodeFile="Leads.aspx.cs" Inherits="Leads" ValidateRequest="false" EnableEventValidation="false" %>
...
<asp:Content ContentPlaceHolderID="Body" runat="server">
    <telerik:RadWindowManager ID="rwm" runat="server" VisibleStatusbar="false" Behaviors="Close, Move" ShowContentDuringLoad="false" 
        ...
        <Windows>
            ...
            <telerik:RadWindow ID="rw_dedupe" runat="server" Title="De-Duplicate Leads" MaxHeight="900" OnClientClose="ProjectListChanged"/>
        </Windows>
            ...
            <telerik:RadSplitter ID="rspl" runat="server" Width="100%" Height="100%" VisibleDuringInit="false">
                <telerik:RadPane ID="rp_side" runat="server" Width="32">
                    <telerik:RadSlidingZone ID="rsz" runat="server" Width="26px" ClickToOpen="false" SlideDuration="400" OnClientLoaded="RSZOnClientLoaded">
                        <telerik:RadSlidingPane ID="rspa_projects" runat="server" Title="My Projects" EnableResize="true" EnableDock="true" Width="450" MaxWidth="600" MinWidth="200" CssClass="RadSlidingPane"
                            OnClientResized="SavePersistence" OnClientDocked="RSPOnClientDocked" OnClientUndocked="RSPOnClientUndocked" TabView="ImageOnly" IconUrl="~/images/leads/ico_tab_leads.png">
                            <%--Project List--%>
                        ...
                        <telerik:RadSlidingPane ID="rspa_tools" runat="server" Title="Tools" EnableResize="true" EnableDock="false" Width="260" MaxWidth="400" MinWidth="250" CssClass="RadSlidingPane"
                            ...
                            <div class="CenteredContainer" style="padding:4px;">
                                ...
                                <telerik:RadButton ID="btn_email_manager" runat="server" Text="Leads Mailer" Height="36px" Width="100%" Enabled="false"
                                    ...
                                    <Icon PrimaryIconUrl="~/images/leads/ico_gmail_24.png" PrimaryIconWidth="24" PrimaryIconHeight="24" PrimaryIconLeft="7" PrimaryIconTop="6"/> <%--BackColor="#F6F6F6"--%>
                                </telerik:RadButton>
                                ...
                                <telerik:RadButton ID="btn_dedupe" runat="server" Text="De-Duplicate Leads" Height="36px" Width="100%"
                                    OnClientClicking="function(b,args){rwm_radopen('dedupeleads.aspx', 'rw_dedupe'); args.cancel(); } ">
                                    <Icon PrimaryIconUrl="~/images/leads/ico_broom.png" PrimaryIconWidth="24" PrimaryIconHeight="24" PrimaryIconLeft="5" PrimaryIconTop="6"/>
                                </telerik:RadButton>
                            </div>
                        </telerik:RadSlidingPane>
