...
<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeFile="FNEditLiab.aspx.cs" MasterPageFile="~/Masterpages/dbm_win.master" Inherits="FNEditLiab" %>
...
<asp:Content ContentPlaceHolderID="Body" runat="server">
    ...
    <table border="0" runat="server" id="tbl" style="font-family:Verdana; font-size:8pt; color:white; width:420px; overflow:visible; position:relative; left:6px; padding:15px;">
        <tr>
            <td colspan="4">
                <asp:Label ID="lbl_title" runat="server" ForeColor="White" Font-Bold="true" style="position:relative; left:-10px; top:-5px;"/> 
            </td>
        </tr>
        <tr>
            <td colspan="1">&nbsp;</td>
        ...
        <tr>
            ...
            <td align="left">
                <div style="width:136px;">
                    <telerik:RadDatePicker ID="dp_date_paid" width="136px" runat="server"/>
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="right" valign="bottom" colspan="4">
                ...
                <asp:LinkButton ID="lb_update" ForeColor="Silver" runat="server" Text="Update" OnClick="UpdateLiab" />
            </td>
        </tr>
    </table>
