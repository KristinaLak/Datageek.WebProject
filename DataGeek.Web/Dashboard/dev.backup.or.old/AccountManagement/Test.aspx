<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test.aspx.cs" Inherits="DataGeek.Web.Dashboard.dev.backup.or.old.AccountManagement.Test" %>
<%--
...
<%@ Page Title="DataGeek :: Account Management" Language="C#" ValidateRequest="false" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Masterpages/dbm.master" AutoEventWireup="true" CodeBehind="OldAccountManagement.aspx.cs" Inherits="DataGeek.Web.OldAccountManagement" %>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td valign="top" align="left">
                        <%-- EXISTING USER--%>
                        <asp:Panel ID="pnl_userpreferences" runat="server" Visible="false" style="margin-left:62px; font-family:Verdana; font-size:8pt">
                            <table border="1" cellpadding="1" cellspacing="0" width="608px" bgcolor="White" style="margin-left:2px; font-family:Verdana; font-size:8pt">
                                <tr>
                                    ...
                                    <td align="right" style="border-left:0px;">
                                        <asp:ImageButton runat="server" alt="Close" Height="17" Width="17" ImageUrl="~\Images\Icons\dashboard_Close.png" OnClick="closeUserPanel" style="position:relative; left:-2px;"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" colspan="2">
                                        <table border="0" cellpadding="1" cellspacing="5" width="100%">
                                            <tr>
                                                ...
                                                <td align="left" valign="top" rowspan="4" style="border-left:1px solid gray;" width="20%"><asp:Label runat="server" Text="&nbsp;CCA Group:"/></td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" valign="top" rowspan="9" style="border-left:1px solid gray;">
                                                    <asp:Label ID="CCATeamRadioButtonLabel" runat="server" Text="&nbsp;CCA Team:"/>
                                                </td>
                                                <td rowspan="9" valign="top"><asp:RadioButtonList ID="CCATeamRadioButton" runat="server"/></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:CheckBox ID="cb_edit_t_and_d_commission" runat="server" AutoPostBack="true" OnCheckedChanged="ToggleEditTandDCommission"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <table ID="tbl_edit_t_and_d_commission" runat="server" visible="false" width="75%">
                                                        <tr><td colspan="2">A trainer will receive X commission on all of this user's deals for the first 90 days of their employ.</td></tr>
                                                        <tr>
                                                            <td>Percentage:</td>
                                                            <td>Trainer:</td>
                                                        </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <telerik:RadColorPicker ID="editUserColourPicker" runat="server"
                                                        ...
                                                        Skin="Vista" SelectedColor="White" style="position:relative; top:12px; left:-100px;">
